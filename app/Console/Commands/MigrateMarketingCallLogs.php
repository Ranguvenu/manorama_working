...
use App\Imports\DataMigrations\CallRequestsMigration;
use Illuminate\Console\Command;
use Illuminate\Support\Facades\File;
use Illuminate\Support\Facades\Log;

class MigrateMarketingCallLogs extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:migrate-marketing-call-logs';
    ...
    {
        Log::channel('migration')->info('---------------Marketing Call Logs--------------------------------');
        $folderPath = public_path('migrationdata/call_logs/data'); // Replace with the actual path to your folder
        $uploadedFolderPath = public_path('migrationdata/call_logs/completed');
        ...
        foreach ($files as $key => $file) {
            ...
            try {
                ...
                $import = new CallRequestsMigration();
                $import->import($file);
