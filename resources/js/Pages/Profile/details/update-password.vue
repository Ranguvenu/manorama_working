            ...
            <div>
                <Transition enter-active-class="transition ease-in-out" enter-from-class="opacity-0"
                    ...
                    <div v-if="form.recentlySuccessful"
                        class="rounded-lg  w-full border border-green-200 p-3 block text-sm bg-green-100 text-green-800">
                        Password updated successfully.</div>
                </Transition>
            </div>
            <ButtonRegular color="primary" size="md" :disabled="form.processing">Update Password</ButtonRegular>
        </form>
    </section>
</template>
