<template>
    <div>
        ...
        <SettingsBase :show="!preview" element="NEATKEAMP Package" :data="data.advanced"
            @close-settings="$emit('close-settings')" @advanced-settings="update_advanced_configuration"
...
export default {
    ...
    emits: ['close-settings', 'update-configuration', 'update-advanced-configuration', 'save-settings'],
    components: {
        ComponentSettings,
        ComponentView,
        SettingsBase
