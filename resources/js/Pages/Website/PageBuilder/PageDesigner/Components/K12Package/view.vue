                ...
                <div class="md:w-3/4 custom_md:w-3/5 w-full flex flex-wrap flex-col">
                    ...
                    <div class="flex flex-row flex-wrap p-8">
                        <div class="md:w-1/2 custom_md:w-full w-full flex items-center mb-5"
                            ...
                            <input type="checkbox" :value="subject.id" v-model="subjects" checked
                                v-on:change="update_pricing" :disabled="!data.is_variable"
                            ...
                            <label class="ml-2 text-emerald-950 text-sm font-medium">{{ subject.title }}</label>
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        ...
        update_pricing() {
            ...
            console.log('variant',vm.variation)
            vm.haspricing = false;
            if(vm.variation && vm.variation.length){
                axios.get(route('ecommerce.pricing.show', { pricing: vm.variation })).then((response) => {
                    ...
                    console.log('hasing:',response.data);
                    vm.haspricing = true;
