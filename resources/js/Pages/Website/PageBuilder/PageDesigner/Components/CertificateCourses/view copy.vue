<template>
    <div class="cc_courses">
        <div :class="'flex items-'+data.title_alignment+'mb-2 justify-'+ data.title_alignment">
            <div class="w-[29px] h-[29px] mr-3">
                <img src="/images/homepage/certificate.png" />
            </div>
            <div class="text-center text-zinc-800 text-[25px] font-semibold leading-[35px] mb-3">{{ data.title }}</div>
        </div>
        ...
        <div v-if="courses && courses.length">
            <div class="flex flex-wrap -mx-2">
                <div class="lg:w-1/4 md:w-1/3 sm:w-1/2 w-full mb-6 px-2" v-for="(course, index) in courses">
                    <div class="w-full shadow border border-zinc-100 rounded-[10px] h-full">
                        <img class="rounded-tl-lg rounded-tr-lg w-full min-h-[150px] max-h-[150px] object-cover"
                        ...
                        <div class="px-3 pt-4">
                            ...
                            <div v-if="course && course.pricing" class="border-t border-gray-200 flex items-center justify-between py-2">
                                ...
                                <div class="flex">
                                    <div v-if="course.pricing.actual_price" class="mr-3">
    ...
    methods: {
        index(page = 1) {
            ...
            axios.post(route('website.components.index', { component: 'certificate-courses', page: page }), payload).then(response => {
                ...
                // console.log('searching for date:',vm.courses);

                // let datetimestring = "2024-02-27 00:00:00";
