<template>
    <div>
        ...
        <SettingsBase :show="!preview" element="Test Package" :data="data.advanced" @close-settings="$emit('close-settings')" @advanced-settings="update_advanced_configuration" @save-settings="$emit('save-settings')">
