<template>
    <div>
        ...
        <SettingsBase :show="!preview" element="Site Map" :data="data.advanced" @close-settings="$emit('close-settings')" @advanced-settings="update_advanced_configuration" @save-settings="$emit('save-settings')">
