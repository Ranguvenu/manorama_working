                ...
                <div class="mt-2 grid-cols-1 gap-x-6  sm:grid-cols-6 px-3">
                    ...
                    <div class="grid grid-cols-1 gap-x-6 gap-y-5 mt-3 sm:grid-cols-12">
                        <div class="col-span-4 mt-3">
                            <InputLabel for="view_label" value="View Label" />
                            <TextInput id="view_label" type="text" class="mt-1 block w-full" v-model="category.more.label"
                                placeholder="View Label" autofocus
                                v-on:keyup="update_configuration" />
                        </div>
                        <div class="col-span-8 mt-3">
                            <InputLabel for="view_link" value="View Link" />
                            <TextInput id="view_link" type="text" class="mt-1 block w-full" v-model="category.more.link"
                                placeholder="View Link" autofocus
                                v-on:keyup="update_configuration" />
                        </div>
                    </div>
