<template>
    <div>
        ...
        <SettingsBase :show="!preview" element="Two Column Image Alternating" :data="data.advanced" @close-settings="$emit('close-settings')" @advanced-settings="update_advanced_configuration" @save-settings="$emit('save-settings')">
