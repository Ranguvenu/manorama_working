<template>
    <div>
        ...
        <SettingsBase :show="!preview" element="Exam Listing" :data="data.advanced" @close-settings="$emit('close-settings')" @advanced-settings="update_advanced_configuration" @save-settings="$emit('save-settings')">
